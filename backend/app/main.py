...
# from app.routes.auth import router as auth_router
# from app.routes.execute import router as execute_router   # ✅ new Judge0 router
# from app.database import initialize_firebase
...
# # Register routes
# app.include_router(health_router, tags=["Health"])
# app.include_router(execute_router, tags=["Code Execution"])   # ✅ no prefix needed, routes already have /api/execute
# app.include_router(teacher.router)
# app.include_router(auth_router)
...
app.include_router(teacher.router)
app.include_router(auth_router)
app.include_router(admin_router)                              # ✅ superadmin routes
